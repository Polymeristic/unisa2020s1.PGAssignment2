...
public abstract class TextCoder {
	...
	// **** EDIT THIS TO BE YOUR OWN STUDENT ID *******
	// i.e. your login name, not your student number.
	...
	// these should be overridden by subclasses to do specific encoding/decoding.
	 ...
	 * 
	 * @return true on success, falso on failure.
	 * @throws DecodeErrorException if the decoding failed
	 */
	abstract protected boolean decode() throws DecodeErrorException;

	/**
	 * Converts a letter to be numerically absolute (ie, 'A' (65) -> 0, 'B' (66) -> 1)
	 ...
	 */
	protected String[] getWords() { return getMessage().split("\\s+"); }
	 ...
	 * @return Array of words
	 */
	protected String[] getWords(char delim) { return getMessage().split("\\" + delim + "+"); }
